...
class ConverterAbstractTest extends TestCase
{
    ...
    /**
     * data provider for convert function. The xmlContent value is hardcoded and taken from sample cms_block_data.xml
     * file present in etc/od_cms directory.
     * @return string[][]
     */
    public function dataProviderForConvert(): array
    {
