...
class Filesystem
{
    const EXPORT_PATH = 'overdose_cmsimportexport/export';
    const EXTRACT_PATH = 'overdose_cmsimportexport/extract';
    const UPLOAD_PATH = 'overdose_cmsimportexport/extract';
